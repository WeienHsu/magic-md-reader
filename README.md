...
1. 到 repo 的 **Settings → Pages**，將 **Source** 設為 **GitHub Actions**（只需做一次）
2. push 到 `main` 分支，`.github/workflows/deploy.yml` 會自動 build 並發佈
3. 網站上線於 `https://<你的帳號>.github.io/magic-md-reader/`
